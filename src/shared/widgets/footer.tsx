...
export function Footer() {
  return (
    <footer className='text-gray-300 pt-12 md:mt-24 border-t border-white/65'>
      {/* ---------- Main Content ---------- */}
      <div
        className='
      ...
      >
        ...
        {/* --- Right Column: Contact + Explore --- */}
        <div
          className='
            order-3 lg:order-2
            grid grid-cols-1 sm:grid-cols-2 gap-12 items-center
          '
        >
          {/* Contact Section */}
          ...
          {/* Explore Section */}
          <div className='flex-col space-y-3 text-left hidden lg:flex'>
        ...
        {/* --- Explore on Mobile (first section) --- */}
      ...
      {/* ---------- Bottom Line ---------- */}
      <div className='border-t border-white/10 mt-12 pt-6 pb-4 text-center text-sm flex flex-col items-center justify-center gap-2'>
